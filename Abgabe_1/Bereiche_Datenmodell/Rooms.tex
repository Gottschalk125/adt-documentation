...
\begin{itemize}
    ...
    \item \textbf{Station:} Repräsentiert eine physische Pflegeeinheit, die funktional fest einem \texttt{department} zugeordnet ist.
    \item \textbf{Rooms (Zimmer):} Jedes Zimmer ist über die \texttt{station\_id} eindeutig lokalisierbar.
