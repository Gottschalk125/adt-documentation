...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]{diagnosis-detail-view.png}
    \caption{Detailansicht einer Diagnose}
    \label{fig:frontend-diagnosis-detail}
\end{figure}
