...
\begin{enumerate}
    ...
    \item \textbf{Probabilistische Verschlüsselung:} Der eigentliche Nutzinhalt wird mittels eines sicheren, authentifizierten Verschlüsselungsverfahrens (AES-GCM-256) mit einem pro Datensatz einzigartigen, zufälligen Initialisierungsvektor (IV) verschlüsselt.
