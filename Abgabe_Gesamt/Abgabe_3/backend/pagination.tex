...
Die in den nachfolgenden Grafiken dargestellten Performance-Verbesserungen ergeben sich aus der Kombination der zuvor beschriebenen Optimierungen durch \texttt{@EntityGraph} sowie der Umstellung von offset-basierter auf cursor-basierte Paginierung.
