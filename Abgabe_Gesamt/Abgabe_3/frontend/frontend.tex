...
Das Frontend wurde im Verlauf des Projekts optisch und strukturell überarbeitet, um eine modernere und benutzerfreundlichere Oberfläche bereitzustellen. Ziel des neuen Designs war insbesondere eine bessere Übersichtlichkeit bei der Darstellung großer Datenmengen sowie eine konsistente Gestaltung aller Seiten und Komponenten.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{../../assets/Frontend/frontend_neuesDesign.png}
