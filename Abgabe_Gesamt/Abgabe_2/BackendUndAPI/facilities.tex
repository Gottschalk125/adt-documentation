...
Dies entkoppelt die API von der internen Datenbankstruktur und verhindert, dass Clients fälschlicherweise versuchen, Sub-Ressourcen (wie Abteilungsnamen) über einen Belegungsendpunkt zu ändern.
...
Um die REST-Architektur jedoch möglichst logisch und konsistent aufzubauen, wurde dieser Use Case in den \texttt{patient}-Endpunkt verschoben. 
Die Begründung hierfür liegt in der semantischen Bedeutung: Eine Verlegung oder Entlassung ist primär ein Ereignis im Lebenszyklus eines Patienten. 
