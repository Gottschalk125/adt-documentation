...
%TODO auf Besonderheit eingehen, dass in Backend nicht nur IDs sondern ganze Objekte, für geringen Network Traffic dann wieder IDs
%TODO in API auf eigene RequestObjects eingehen

%bei API: 404 statt null
%bei API: auf combined search functions mit parametern eingehen